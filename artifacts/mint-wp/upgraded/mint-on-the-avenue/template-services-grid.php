							...
							<section id="testimonials">
								...
								<div class="row">
									...
									<?php if ( $parent->have_posts() ) : while ( $parent->have_posts() ) : $parent->the_post(); ?>
										<div class="medium-3 columns testimonial">
											<a class="loadtestimonials" href="#parent-<?php the_ID(); ?>"><div><h3 class="services-title" style="background-image:linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.2)), url(<?php the_field('page_title_image', $page_id); ?>)"><?php the_title(); ?></h3></div></a>
										</div>									
									<?php endwhile; endif; wp_reset_postdata(); ?>
								</div>
								<div class="row testimonial-wrap">
									<?php if ( $parent->have_posts() ) : while ( $parent->have_posts() ) : $parent->the_post(); ?>
										<div class="columns medium-12 testimonial-content testimonials" id="parent-<?php the_ID(); ?>" style="display: none;">
											<h2><?php the_title(); ?></h2>
											<?php the_content(); ?>
										</div>
									<?php endwhile; endif; wp_reset_postdata(); ?>
