<?php
/**
 * Atelier Front Page (template hierarchy override).
 * This file ensures the atelier home renders as the WP front page
 * regardless of the parent theme's templates or Reading settings.
 * Mirrors page-home.php exactly.
 */
get_header();
?>
